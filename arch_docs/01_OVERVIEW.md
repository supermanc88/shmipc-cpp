...
- `S-0205` 验证：reserve/write/publish、单 slice 零拷贝、跨 slice owned copy、peek、byte/string/discard、pin/release 与析构回收已通过本机 Go oracle 10/10、ASan+UBSan 9/9、TSan 9/9，以及远端 GCC 8.5 Debug/ASan 9/9；云端门禁等待本批 push。
