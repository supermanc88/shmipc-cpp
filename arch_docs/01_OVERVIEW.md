...
- `S-0303` 验证：C++ client 与 C++ test peer、真实 Go server 均完成 20,000 字节请求和 17,000 字节响应，覆盖跨 slice adopt/recycle、Polling、receive timeout 与双向 close；远端 GCC 8.5 Debug/ASan 及 Go 互操作 50/50 通过，等待云端门禁。
